    ...
    <footer className="relative bg-[var(--surface)] border-t border-[var(--border)] overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="py-16 border-b border-[var(--border)]">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            ...
            >
              ...
              <h2 className="text-4xl sm:text-5xl font-black text-[var(--text)] leading-tight max-w-xl">
                {t('contact.subtitle')}
              </h2>
            </motion.div>
            ...
            <motion.a
              ...
              className="group shrink-0 inline-flex items-center gap-3 rounded-full bg-[var(--lime)] px-8 py-4 text-sm font-bold uppercase tracking-wider text-black hover:brightness-110 transition-all duration-200 w-fit"
            >
              {t('hero.contactMe')}
        ...
        <div className="py-12 grid grid-cols-2 sm:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-[var(--muted)] text-[11px] font-mono uppercase tracking-widest mb-4 opacity-70">
              {t('nav.home')}
            </h4>
